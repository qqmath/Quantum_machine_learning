            ...
            for i in range(ncube):
                for j in range(ncube):
                    for k in range(ncube):
                        ...
                        #if (i == 3 and j == 0 and k == 3) or (i == 3 and j == 1 and k == 3) or (i == 2 and j == 0 and k == 3) or (i == 2 and j == 1  and k == 3) or \
                        #   (i == 3 and j == 0 and k == 2) or (i == 3 and j == 1 and k == 2) or (i == 2 and j == 0 and k == 2) or (i == 2 and j == 1  and k == 2) :
                        #if (i == 1 and j == 0 and k == 3) or (i == 1 and j == 1 and k == 3) or (i == 2 and j == 0 and k == 3) or (i == 2 and j == 1  and k == 3) or \
                        #   (i == 1 and j == 0 and k == 2) or (i == 1 and j == 1 and k == 2) or (i == 2 and j == 0 and k == 2) or (i == 2 and j == 1  and k == 2) :
...
def calc_feature_map_neuron_loc( n_feature_map, ncube, cube_size, positions_x, positions_y, make_single_cube_active_cube=False ) :
                    ...
                    for k in range(ncube) :
                        ...
                        if (i == 3 and j == 0 and k == 1) or (i == 3 and j == 1 and k == 1) or (i == 2 and j == 0 and k == 1) or (i == 2 and j == 1  and k == 1) or \
                           (i == 3 and j == 0 and k == 2) or (i == 3 and j == 1 and k == 2) or (i == 2 and j == 0 and k == 2) or (i == 2 and j == 1  and k == 2) :
                            ...
                            neuron_loc_z[n] = k*cube_size-offset
                            n+=1
    return neuron_loc_x[:n], neuron_loc_y[:n], neuron_loc_z[:n]
...
input_layer_filename = "C:\\Users\\phoni\\Dropbox\\Temp\\input_layer.dat"
...
input_layer_neuron_x, input_layer_neuron_y, input_layer_neuron_z = calc_feature_map_neuron_loc( draw_n_input, 4, cube_size, input_layer_pos_x, input_layer_pos_y)
print(input_layer_neuron_z)
...
feature_extraction_layer_filename = "C:\\Users\\phoni\\Dropbox\\Temp\\feature_extraction_layer.dat"
...
feature_map1_neuron_x, feature_map1_neuron_y, feature_map1_neuron_z = calc_feature_map_neuron_loc( draw_n_feature_map1, 3, cube_size, feature_map1_pos_x, feature_map1_pos_y, make_single_cube_active_cube=True)
#feature_map1_neuron_x, feature_map1_neuron_y, feature_map1_neuron_z = calc_feature_map_neuron_loc( draw_n_feature_map1, 3, cube_size, feature_map1_pos_x+0.75, feature_map1_pos_y-0.75)

# Draw the cubes
makecubes( 3, cube_size, feature_map1_pos_x, feature_map1_pos_y, feature_maps, make_single_cube_active_cube=True )
...
#for j in range(len(input_layer_neuron_x)) :
#for i in range(len(feature_map1_pos_x)):
i = 0
make_neuron_connections(feature_map1_neuron_x[i], feature_map1_neuron_y[i], input_layer_neuron_x, input_layer_neuron_y, z_right = feature_map1_neuron_z[i], z_left_array=input_layer_neuron_z )
...
scene.render.resolution_x = 2048 # 1920
scene.render.resolution_y = 1080 #1440
...
#scene.camera.location.x =23.5
#scene.camera.location.y = -9.54
#scene.camera.location.z = 8
#scene.camera.rotation_euler[0] = deg_to_rad(59.)
#scene.camera.rotation_euler[1] = deg_to_rad(0.)
#scene.camera.rotation_euler[2] = deg_to_rad(86.)

#scene.camera.location.x =23.8
#scene.camera.location.y = -14.1
#scene.camera.location.z = 8
#scene.camera.rotation_euler[0] = deg_to_rad(61.9)
#scene.camera.rotation_euler[1] = deg_to_rad(0.)
#scene.camera.rotation_euler[2] = deg_to_rad(74.)

#scene.camera.location.x =25.5
#scene.camera.location.y = -15.5
#scene.camera.location.z = 8
#scene.camera.rotation_euler[0] = deg_to_rad(66.)
#scene.camera.rotation_euler[1] = deg_to_rad(0.)
#scene.camera.rotation_euler[2] = deg_to_rad(70.)

scene.camera.location.x =25.5
scene.camera.location.y = -22.25
scene.camera.location.z = 8
scene.camera.rotation_euler[0] = deg_to_rad(71)
scene.camera.rotation_euler[1] = deg_to_rad(0.)
scene.camera.rotation_euler[2] = deg_to_rad(55.2)
